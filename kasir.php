...
<div class="content">
  ...
  <form action="kasir.php" enctype="multipart/form-data"method="post">
          ...
          <input type="hidden" name="action" id="action" value="save" />
            ...
            <tr> 	
 					<tr valign="baseline">
                      <td nowrap="nowrap" align="right">Kode Kasir</td>
                      <td>:</td>
                      <td><input type="text" id="kode_kasir" name="kode_kasir"  value="<?php echo $kd_new; ?>" readonly="readonly"size="32" /></td>
                    </tr>
                    <tr valign="baseline">
                      <td nowrap="nowrap" align="right">KTP</td>
                      <td>:</td>
                      <td><input type="text" name="no_ktp" id="no_ktp"  size="32" /></td>
                    </tr>
                    <tr valign="baseline">
                      <td nowrap="nowrap" align="right">nama </td>
                      <td>:</td>
                      <td><input type="text" name="nama" id="nama"  size="32" /></td>
                    </tr>
                    <tr valign="baseline">
                      <td nowrap="nowrap" align="right">alamat</td>
                      <td>:</td>
                      <td><input type="text" name="alamat" id="alamat"  size="32" /></td>
                    </tr>
                    <tr valign="baseline">
                      <td nowrap="nowrap" align="right">telpon</td>
                      <td>:</td>
                      <td><input type="text" name="telpon" id="telpon"  size="32" /></td>
                    </tr>
                    <tr valign="baseline">
                      <td nowrap="nowrap" align="right">status</td>
                      <td>:</td>
                      <td><input type="text" name="status" id="status"  size="32" /></td>
                    </tr>
					<tr valign="baseline">
                      <td nowrap="nowrap" align="right">Password</td>
                      <td>:</td>
                      <td><input type="text" name="pass" id="pass"  size="32" /></td>
                    </tr>
   ...
   <div class="notif animated bounce"> SILAHKAN LOGIN MENGGUNAKAN : USERNAME = KODE KASIR , PASSWORD = PASSWORD </div>
</div>
<div class="footer">
